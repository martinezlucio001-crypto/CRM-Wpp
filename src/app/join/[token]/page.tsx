...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Verifique a URL ou peça para a pessoa que te convidou enviar um novo link.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo link — leva apenas alguns segundos para ser gerado.',
  },
  server_error: {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 409) {
          setConflictMessage(
            payload.error ||
              'Você já está em outra conta. Faça login com um e-mail diferente para participar desta.',
          );
        } else {
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              ...
              conta pessoal vazia criada no cadastro será limpa.
            </p>
          </CardContent>
        </Card>
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-popover-foreground">
                ...
                Não é possível participar de {peek.account_name} com esta conta
              </DialogTitle>
