          ...
          <Table>
            <TableHeader>
              <TableRow className="border-border hover:bg-transparent">
                ...
                <TableHead className="hidden text-muted-foreground lg:table-cell">Entregas</TableHead>
                <TableHead className="hidden text-muted-foreground lg:table-cell">Leituras</TableHead>
