...
const navItems: NavItem[] = [
  ...
  { href: "/pipelines", label: "Processos", icon: GitBranch },
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          // Desktop: static, visible or collapsed.
          "lg:static lg:z-0 lg:transition-all lg:duration-300 lg:will-change-[width,transform,opacity]",
          isCollapsed
            ? "lg:w-0 lg:-translate-x-full lg:border-r-0 lg:opacity-0 lg:pointer-events-none"
            : "lg:w-60 lg:translate-x-0 lg:opacity-100",
        )}
        aria-label="Primary"
      >
