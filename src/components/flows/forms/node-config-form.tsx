...
export function NodeConfigForm({
  ...
  switch (node.node_type) {
        ...
        <>
          ...
          <div>
            <label className="mb-1 block text-xs text-muted-foreground">
              Chave da variável (salva em flow_runs.vars; alfanumérico + sublinhado)
            </label>
            <Input
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Interpole nas próximas perguntas e notas de encaminhamento com{" "}
    ...
    case "handoff":
      return (
        <TextRow
          label="Nota interna (para o agente que assumir o contato)"
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó terminal. Quando a execução alcança este nó, ela é marcada como concluída. Nenhuma configuração necessária.
        </p>
      );
  }
}
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <TextRow
          label="Texto do botão de expansão (≤20 chars)"
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="tag">Contato possui marcador</SelectItem>
        ...
        <div className="md:col-span-2">
          ...
          {subject === "tag" && tags.length > 0 ? (
            ...
            >
              <SelectTrigger className="bg-muted">
                <SelectValue placeholder="Escolha um marcador…" />
              </SelectTrigger>
              <SelectContent>
                {tags.map((t) => (
            ...
            <Input
              ...
              placeholder={subject === "var" ? "ex: email" : "UUID do marcador"}
              className="bg-muted font-mono text-xs"
            />
          )}
        </div>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <div>
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="add">Adicionar marcador</SelectItem>
              <SelectItem value="remove">Remover marcador</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div>
          <label className="mb-1 block text-xs text-muted-foreground">Marcador</label>
          {tags.length > 0 ? (
            <Select
              value={cfg.tag_id ?? ""}
  ...
  return (
    <>
      ...
      {isDocument && (
        <div>
          <label className="mb-1 block text-xs text-muted-foreground">
            Nome do arquivo exibido para o cliente (apenas documentos)
          </label>
          <Input
            value={cfg.filename ?? ""}
