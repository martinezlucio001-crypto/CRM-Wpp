...
export function PasswordForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!profile?.email) {
      toast.error('Não é possível alterar a senha sem um e-mail configurado');
      return;
    }
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-muted-foreground">
          Use pelo menos {MIN_PASSWORD} caracteres. Você continuará conectado neste
          dispositivo após alterá-la.
        </CardDescription>
      </CardHeader>
