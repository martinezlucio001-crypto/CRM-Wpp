...
export function ProfileForm() {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Seu perfil"
        description="Como você aparece no aplicativo. Seu avatar e nome aparecem no cabeçalho, barra lateral e em qualquer lugar onde seus colegas de equipe vejam você."
      />
              ...
              <div>
                ...
                <dd className="mt-0.5 font-mono text-foreground">
                  {profile?.role ? {
                    ...
                    agent: 'Agente',
                    viewer: 'Visualizador'
                  }[profile.role] || profile.role : 'usuário'}
                </dd>
              </div>
              <div>
