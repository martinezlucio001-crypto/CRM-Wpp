  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        ...
        description="A moeda usada para novos negócios e para os totais de pipeline e do painel."
      />
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Novos negócios usam esta moeda por padrão, e os totais de pipeline e do
            painel são mostrados nela. Negócios existentes mantêm a
