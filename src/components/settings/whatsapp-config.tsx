    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte a API do WhatsApp Business da Meta. Credenciais, webhook e etapas de configuração estão todos aqui."
        />
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu token de acesso está autenticado com a Meta. Veja o Status de Registro abaixo para verificar se os webhooks estão conectados.'
              : statusMessage ||
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registrado — a Meta entregará eventos para o wacrm'
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Insira (ou corrija) o PIN de confirmação em duas etapas abaixo e clique em Salvar Configuração para tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes do rastreamento de registro existir, ou o registro foi ignorado. Insira o PIN de confirmação em duas etapas abaixo e clique em Salvar Configuração para se inscrever.
                </>
              )}
            </AlertDescription>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para direcionar mensagens <strong className="text-muted-foreground">recebidas</strong> para um número em <strong className="text-muted-foreground">produção</strong>. Configure-o em <strong className="text-muted-foreground">Gerenciador de Negócios da Meta → Contas do WhatsApp → Números de Telefone → Confirmação em duas etapas</strong>, depois cole-o aqui para que o wacrm possa inscrever o número — caso contrário, a Meta direcionará eventos recebidos para o aplicativo que o reivindicou por último (o sintoma que afeta segundos números sob uma WABA compartilhada). Os <strong className="text-muted-foreground">números de teste da Meta</strong> não possuem PIN e já vêm pré-registrados — deixe em branco para eles. Deixar em branco também mantém o registro existente intacto.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como retorno de chamada (callback) do webhook no Painel de Aplicativos da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <Label className="text-muted-foreground">URL de Retorno de Chamada do Webhook</Label>
      ...
      <div>
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Siga estas etapas para conectar a API do WhatsApp Business da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Accordion>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Siga o assistente de configuração para associar seu negócio</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Gere um <strong className="text-foreground">Token de Acesso Permanente</strong> em Configurações de Negócios &gt; Usuários do Sistema</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Cole a <strong className="text-foreground">URL de Retorno de Chamada do Webhook</strong> indicada acima</li>
